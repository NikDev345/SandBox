...
/* ── Tool registry ──────────────────────────────────────── */
const TOOL_REGISTRY = {
  'sql-generator':         { icon: 'fa-solid fa-database',              cat: 'code',         label: 'SQL Generator' },
  'sql_gen':               { icon: 'fa-solid fa-database',              cat: 'code',         label: 'SQL Generator' },
  'regex-generator':       { icon: 'fa-solid fa-code',                  cat: 'code',         label: 'Regex Generator' },
  'regex-gen':             { icon: 'fa-solid fa-code',                  cat: 'code',         label: 'Regex Generator' },
  'json-fixer':            { icon: 'fa-solid fa-file-code',             cat: 'code',         label: 'JSON Fixer' },
  'JSON-FIXER':            { icon: 'fa-solid fa-file-code',             cat: 'code',         label: 'JSON Fixer' },
  'code-reviewer':         { icon: 'fa-solid fa-magnifying-glass-code', cat: 'code',         label: 'Code Reviewer' },
  'code':                  { icon: 'fa-solid fa-magnifying-glass-code', cat: 'code',         label: 'Code Reviewer' },
  'commit-gen':            { icon: 'fa-solid fa-code-commit',           cat: 'code',         label: 'Commit Generator' },
  'docker':                { icon: 'fa-brands fa-docker',               cat: 'code',         label: 'Docker Helper' },
  'yaml':                  { icon: 'fa-solid fa-dharmachakra',          cat: 'code',         label: 'YAML Helper' },
  'error-explainer':       { icon: 'fa-solid fa-triangle-exclamation',  cat: 'code',         label: 'Error Explainer' },
  'error':                 { icon: 'fa-solid fa-triangle-exclamation',  cat: 'code',         label: 'Error Explainer' },
  'text-summarizer':       { icon: 'fa-solid fa-align-left',            cat: 'text',         label: 'Text Summarizer' },
  'email-rewriter':        { icon: 'fa-solid fa-envelope',              cat: 'text',         label: 'Email Rewriter' },
  'blog-outline-generator':{ icon: 'fa-solid fa-file-lines',            cat: 'text',         label: 'Blog Outline' },
  'notes-cleaner':         { icon: 'fa-solid fa-check-to-slot',         cat: 'text',         label: 'Notes Cleaner' },
  'notes_cleaner':         { icon: 'fa-solid fa-check-to-slot',         cat: 'text',         label: 'Notes Cleaner' },
  'eli5':                  { icon: 'fa-solid fa-lightbulb',             cat: 'text',         label: 'ELI5' },
  'table-extractor':       { icon: 'fa-solid fa-table',                 cat: 'data',         label: 'Table Extractor' },
  'table_extractor':       { icon: 'fa-solid fa-table',                 cat: 'data',         label: 'Table Extractor' },
  'chart-explainer':       { icon: 'fa-solid fa-chart-line',            cat: 'data',         label: 'Chart Explainer' },
  'youtube-summarizer':    { icon: 'fa-brands fa-youtube',              cat: 'media',        label: 'YouTube Summarizer' },
  'screenshot-explainer':  { icon: 'fa-regular fa-image',               cat: 'media',        label: 'Screenshot Explainer' },
  'ss_explain':            { icon: 'fa-regular fa-image',               cat: 'media',        label: 'Screenshot Explainer' },
  'image-text-extractor':  { icon: 'fa-solid fa-text-width',            cat: 'media',        label: 'Image Text Extractor' },
  'mock-api':              { icon: 'fa-solid fa-plug',                  cat: 'productivity', label: 'Mock API' },
  'mock_api':              { icon: 'fa-solid fa-plug',                  cat: 'productivity', label: 'Mock API' },
  'quiz-generator':        { icon: 'fa-solid fa-circle-question',       cat: 'productivity', label: 'Quiz Generator' },
  'flashcard-generator':   { icon: 'fa-solid fa-layer-group',           cat: 'productivity', label: 'Flashcard Generator' },
  'decision-maker':        { icon: 'fa-solid fa-code-branch',           cat: 'productivity', label: 'Decision Maker' },
  'pros-cons-generator':   { icon: 'fa-solid fa-scale-balanced',        cat: 'productivity', label: 'Pros & Cons' },
  'pro_cons_gen':          { icon: 'fa-solid fa-scale-balanced',        cat: 'productivity', label: 'Pros & Cons' },
  'brainstorm-generator':  { icon: 'fa-solid fa-brain',                 cat: 'productivity', label: 'Brainstorm' },
  'action-item':           { icon: 'fa-solid fa-list-check',            cat: 'productivity', label: 'Action Items' },
  'item':                  { icon: 'fa-solid fa-list-check',            cat: 'productivity', label: 'Action Items' },
};

const CAT_LABELS = {
  code: 'Code', text: 'Text & Writing',
