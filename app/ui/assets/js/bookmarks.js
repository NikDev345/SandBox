...
const TOOL_REGISTRY = {
  ...
  'sql_generator':          { icon: 'fa-solid fa-database',              cat: 'developer', label: 'SQL Generator' },
  'regex-generator':        { icon: 'fa-solid fa-code',                  cat: 'developer', label: 'Regex Generator' },
  'json_fixer':             { icon: 'fa-solid fa-file-code',             cat: 'developer', label: 'JSON Fixer' },
  'mock_api':               { icon: 'fa-solid fa-plug',                  cat: 'developer', label: 'API Mock Generator' },
  'docker_generator':       { icon: 'fa-brands fa-docker',               cat: 'developer', label: 'Dockerfile Generator' },
  'yaml_generator':         { icon: 'fa-solid fa-dharmachakra',          cat: 'developer', label: 'Kubernetes YAML Generator' },
  'commit_msg':             { icon: 'fa-solid fa-code-commit',           cat: 'developer', label: 'Commit Message Generator' },
  'code_reviewer':          { icon: 'fa-solid fa-magnifying-glass-code', cat: 'developer', label: 'Code Reviewer' },
  'error_explainer':        { icon: 'fa-solid fa-triangle-exclamation',  cat: 'developer', label: 'Error Explainer' },

  /* ── Category B: Content Tools ── */
  'youtube_summarizer':     { icon: 'fa-brands fa-youtube',              cat: 'content', label: 'YouTube Summarizer' },
  'text_summarizer':        { icon: 'fa-solid fa-align-left',            cat: 'content', label: 'Article Summarizer' },
  'eli5':                   { icon: 'fa-solid fa-lightbulb',             cat: 'content', label: 'ELI5 Generator' },
  'quiz_generator':         { icon: 'fa-solid fa-circle-question',       cat: 'content', label: 'Quiz Generator' },
  'flashcard_generator':    { icon: 'fa-solid fa-layer-group',           cat: 'content', label: 'Flashcard Generator' },
  'blog_generator': { icon: 'fa-solid fa-file-lines',            cat: 'content', label: 'Blog Outline Generator' },

  /* ── Category C: Productivity Tools ── */
  'decision_maker':         { icon: 'fa-solid fa-code-branch',           cat: 'productivity', label: 'Decision Maker' },
  'pros_cons':    { icon: 'fa-solid fa-scale-balanced',        cat: 'productivity', label: 'Pros Cons Generator' },
  'text_summarizer':     { icon: 'fa-solid fa-users',                 cat: 'productivity', label: 'Meeting Summarizer' },
  'item_extractor':                   { icon: 'fa-solid fa-list-check',            cat: 'productivity', label: 'Action Item Extractor' },
  'notes_cleaner':          { icon: 'fa-solid fa-check-to-slot',         cat: 'productivity', label: 'Note Cleaner' },
  'email_rewriter':         { icon: 'fa-solid fa-envelope',              cat: 'productivity', label: 'Email Rewriter' },
  'brainstorm_generator':   { icon: 'fa-solid fa-brain',                 cat: 'productivity', label: 'Brainstorm Generator' },

  /* ── Category D: Image Tools ── */
  'ss_explainer':             { icon: 'fa-regular fa-image',               cat: 'image', label: 'Screenshot Explainer' },
  'image_text_extractor':   { icon: 'fa-solid fa-text-width',            cat: 'image', label: 'Image Text Extractor' },
  'table_extractor':        { icon: 'fa-solid fa-table',                 cat: 'image', label: 'Table Extractor' },
  'chart_explainer':        { icon: 'fa-solid fa-chart-line',            cat: 'image', label: 'Chart Explainer' },
};
